...
function chimera_solution(;
  ...
  A_12[J, y_coarse_left_index] = β_1[end] * (1 - α)
  A_12[J, y_coarse_right_index] = β_1[end] * α
  ...
  A_21[1, y_fine_left_index] = -β_0[1] * (1 - α)
  A_21[1, y_fine_right_index] = -β_0[1] * α
